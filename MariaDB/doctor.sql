...
DROP TABLE IF EXISTS `contacto_profesional_salud`;
...
DROP TABLE IF EXISTS `especialidad_por_profesional`;
...
DROP TABLE IF EXISTS `medicamentos_por_receta`;
...
DROP TABLE IF EXISTS `tipo_estado_receta`;
...
DROP TABLE IF EXISTS `tratamiento_medico`;
