...
import api2018.g1.siemadata.Receta;
 ...
 */
@Stateless
@Path("api2018.g1.siemadata.receta")
public class RecetaFacadeREST extends AbstractFacade<Receta> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Receta entity) {
        super.edit(entity);
    }
    ...
    public Receta find(@PathParam("id") Long id) {
